...
const MissionCrewListItemPam: React.FC<CrewListProps> = ({ index, name, passenger, handleEdit, handleDelete }) => {
  return (
    <FlexboxGrid key={`${name}-${index}`} align={'middle'}>
      ...
      <FlexboxGrid.Item colspan={7}>
        {
          <Text as="h3" truncate={true} color={THEME.color.gunMetal} weight={'medium'} data-testid="crew-member-role">
      ...
      <FlexboxGrid.Item colspan={7}>
        <FlexboxGrid align={'middle'} justify="start">
          ...
          <FlexboxGrid.Item colspan={20}>
            <Text as="h3" truncate={true} color={THEME.color.charcoal} data-testid="crew-member-role">
