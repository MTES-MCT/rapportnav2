...
import { Accent, Button, FormikEffect, FormikSelect, Label, Size, THEME } from '@mtes-mct/monitor-ui'
              ...
              <Stack direction="column" spacing={'2rem'}>
                ...
                <Stack.Item style={{ width: '100%' }}>
                  <Stack direction="row" spacing={'1rem'}>
                    ...
                    <Stack.Item grow={1}>
                      <Button accent={Accent.SECONDARY} size={Size.LARGE} onClick={handleClose} isFullWidth={true}>
                        Annuler
                      </Button>
                    </Stack.Item>
                    <Stack.Item grow={3}>
