...
const TrashMissionCrewFormPam: React.FC<MissionCrewModalProps> = ({ agents, crewMembers, handleClose, handleEdit }) => {
    ...
    <Dialog>
      <Dialog.Title>
        <FlexboxGrid align="middle" justify="space-between" style={{ paddingLeft: 24, paddingRight: 24 }}>
          <FlexboxGrid.Item>Ajout d’un membre d’équipage du DCS</FlexboxGrid.Item>
          <FlexboxGrid.Item>
...
export default TrashMissionCrewFormPam
