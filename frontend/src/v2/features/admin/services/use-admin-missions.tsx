...
const useMissionsListQuery = (page: number = 0, pageSize: number = 10) => {
  const fetchMissions = (): Promise<PaginatedResponse<AdminMission>> =>
    axios.get(`admin/missions`, { params: { page, size: pageSize } }).then(response => response.data)

  return useQuery<PaginatedResponse<AdminMission>>({
    queryKey: ['admin-missions', page, pageSize],
