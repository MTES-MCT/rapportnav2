...
import MissionInfractionForm2 from './mission-infraction-form2'

type NewInfraction = { newInfraction: Infraction }

export interface MissionInfractionFormNew2Props {
  isDisabled: boolean
  controlType: ControlType
  onSubmit: (infraction: Infraction) => void
}

const MissionInfractionFormNew2: FC<MissionInfractionFormNew2Props> = ({ isDisabled, onSubmit, controlType }) => {
...
export default MissionInfractionFormNew2
