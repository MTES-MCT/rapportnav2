...
describe('MissionListPamPage', () => {
  ...
  describe('hook integration', () => {
    ...
    it('should pass correct query params to useMissionsQuery', () => {
      render(<MissionListPamPage />)

      expect(useMissionsQuery).toHaveBeenCalledWith({
        startDateTimeUtc: '2025-01-01T00:00:00.000Z',
        endDateTimeUtc: '2025-12-31T23:59:59.999Z'
      })
    })
  })
})
