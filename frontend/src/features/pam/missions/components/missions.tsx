...
import { GET_MISSION_BY_ID } from '../../mission/hooks/use-mission-by-id.tsx'
        ...
        <Stack.Item alignSelf={'center'} style={{ width: '100%' }}>
          <Stack direction="column" justifyContent="center" spacing={'1rem'}>
            <Stack.Item alignSelf={'center'} style={{ maxWidth: '50%' }}>
              <Text as={'h3'}>
                Une erreur s'est produite lors du chargement de vos missions. Si le problème persiste, veuillez
                contacter l'équipe RapportNav.
              </Text>
            </Stack.Item>
            <Stack.Item alignSelf={'center'} style={{ maxWidth: '50%' }}>
              <Text as={'h3'} color={THEME.color.lightGray} fontStyle={'italic'}>
