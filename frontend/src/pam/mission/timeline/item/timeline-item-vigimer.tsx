...
import { ActionVigimer as NavActionVigimer } from '../../../../types/action-types.ts'


const ActionVigimer: React.FC<MissionTimelineItemProps> = ({action, onClick}) => {
        ...
        <Stack direction="row" spacing="0.5rem">
          ...
          <Stack.Item alignSelf="flex-start" style={{maxWidth: 'calc(100% - 3rem)'}}>
            <Text as="h3" weight="medium" color={THEME.color.gunMetal} style={{
              ...
              {capitalize(actionData?.observations) || 'Permanence Vigimer'}
            </Text>
