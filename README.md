...
- set/modify env
  variables: `ENV_DB_URL=jdbc:postgresql://localhost:5432/rapportnavdb?user=postgres&password=postgres;MONITORFISH_API_KEY=fake-key;JWT_SECURITY_KEY=somerandomkeywhichislongenoughtoalignwiththejwtspecification;MASTER_API_KEY=somerandomkeywhichislongenoughtoalignwiththejwtspecification;`
- set VM
