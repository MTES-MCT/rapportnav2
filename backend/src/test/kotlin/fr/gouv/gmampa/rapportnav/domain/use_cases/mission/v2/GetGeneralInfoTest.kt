...
class GetGeneralInfoTest {
    ...
    fun `should create general info for missionId when not exists`() {
        ...
        val createdEntity = GeneralInfoEntityMock.create(id = 1, missionId = missionId, service = service)
        ...
        whenever(createGeneralInfos.execute(
            ...
            generalInfo2 = any(),
            service = anyOrNull()
        )).thenReturn(fr.gouv.dgampa.rapportnav.domain.entities.mission.v2.MissionGeneralInfoEntity(data = createdEntity))
