...
import fr.gouv.dgampa.rapportnav.infrastructure.api.bff.adapters.v2.ControlNavigationInput2
...
class ControlNavigationInput2Test {
    @Test
    fun `execute should convert into entity`() {
        val input = ControlNavigationInput2(
