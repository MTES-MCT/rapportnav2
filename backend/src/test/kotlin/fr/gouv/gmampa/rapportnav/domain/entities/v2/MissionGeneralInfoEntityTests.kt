...
class MissionGeneralInfoEntityTests {
        ...
        inner class IsCompleteForStatsPamTests {
            ...
            fun `should return true when crew is not empty and correct general info`() {
                ...
                val entity = MissionGeneralInfoEntity(data = data, crew = crew)
            ...
            fun `should return false when data is null`() {
                // Given
                val entity = MissionGeneralInfoEntity(data = null, crew = emptyList())
            ...
            fun `should return false when consumedFuelInLiters is null`() {
                ...
                val entity = MissionGeneralInfoEntity(data = data, crew = emptyList())
            ...
            fun `should return false when crew is null and data is complete`() {
                // Given
                val data = createCompleteDataPam()
                val entity = MissionGeneralInfoEntity(data = data, crew = null)
        ...
        private fun createCompleteDataPam(): GeneralInfoEntity {
    ...
    // Helper method to create a complete MissionGeneralInfoEntity
    private fun createCompleteDataUlam(): GeneralInfoEntity {
        return GeneralInfoEntity(
            id = 1,
            missionId = 1,
