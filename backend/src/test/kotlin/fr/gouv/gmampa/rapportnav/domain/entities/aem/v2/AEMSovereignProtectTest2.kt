...
import fr.gouv.dgampa.rapportnav.domain.entities.aem.v2.AEMSovereignProtect2
...
@SpringBootTest(classes = [AEMSovereignProtect2::class])
class AEMSovereignProtectTest2 {
    ...
    fun `Should init sovereign protect with different values`() {
        ...
        val sovereign = AEMSovereignProtect2(navActions, envActions, fishActions, missionEndDate);
