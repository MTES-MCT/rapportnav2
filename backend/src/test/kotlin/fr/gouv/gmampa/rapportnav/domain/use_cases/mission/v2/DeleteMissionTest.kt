...
class DeleteMissionTest {
    ...
    @Test
    fun `should delete both env and nav mission when externalId exists`() {
        val id = UUID.randomUUID()
        val serviceId = 5
    ...
    @Test
    fun `should delete only nav mission when externalId is null`() {
        val id = UUID.randomUUID()
        val serviceId = 5
    ...
    @Test
    fun `should not delete nav mission when deleteEnvMission throws`() {
        val id = UUID.randomUUID()
        val serviceId = 5
        val navMission = MissionNavEntityMock.create(id = id, externalId = "123", serviceId = serviceId)
