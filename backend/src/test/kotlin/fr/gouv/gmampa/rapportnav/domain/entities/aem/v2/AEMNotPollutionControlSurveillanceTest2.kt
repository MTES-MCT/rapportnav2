...
import fr.gouv.dgampa.rapportnav.domain.entities.aem.v2.AEMNotPollutionControlSurveillance2
...
@SpringBootTest(classes = [AEMNotPollutionControlSurveillance2::class])
class AEMNotPollutionControlSurveillanceTest2 {
    ...
    fun `Should init not pollution control surveillance with different values`() {
        ...
        val notPollution = AEMNotPollutionControlSurveillance2(envActions = actions)
