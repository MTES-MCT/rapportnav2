...
class CreateUserTest {
    ...
    @Test
    fun `should throw BackendUsageException when required fields are empty`() {
        val input = AuthRegisterDataInput(
            id = null,
            firstName = "",
            lastName = "Doe",
    ...
    fun `should throw BackendUsageException when user already exists`() {
        ...
        assertThat(exception.code).isEqualTo(BackendUsageErrorCode.ALREADY_EXISTS_EXCEPTION)
