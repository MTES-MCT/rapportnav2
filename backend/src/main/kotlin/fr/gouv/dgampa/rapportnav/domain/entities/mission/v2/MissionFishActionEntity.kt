...
class MissionFishActionEntity(
    ...
    override val isPrioritized: Boolean? = false,
    ...
    companion object {
        fun fromFishAction(action: FishAction) = MissionFishActionEntity(
            ...
            vmsEmissionControlBeforeArrival = action.vmsEmissionControlBeforeArrival,
            portEntranceAndLandingAuthorized = action.portEntranceAndLandingAuthorized,
            logbookOpenedPriorToControl = action.logbookOpenedPriorToControl,
            ...
            propulsionEnginePowerControl = action.propulsionEnginePowerControl,
            fishingLicencesMatchActivity = action.fishingLicencesMatchActivity,
            europeanFishingLicenceValid = action.europeanFishingLicenceValid,
            weighingOperationsMonitoredByInspectors = action.weighingOperationsMonitoredByInspectors,
            stowagePlanPresent = action.stowagePlanPresent,
            onboardWeighingPermit = action.onboardWeighingPermit,
            weighingCertificateAndSystemsValid = action.weighingCertificateAndSystemsValid,
            underSizedSeparateStowage = action.underSizedSeparateStowage,
            underSizedSeparateRecording = action.underSizedSeparateRecording,
            minimumConservationReferenceSizeControlled = action.minimumConservationReferenceSizeControlled,
            cratesWeighingSamplingControl = action.cratesWeighingSamplingControl,
            approvedWeighingOperatorInformation = action.approvedWeighingOperatorInformation,
            holdControlledAfterUnloading = action.holdControlledAfterUnloading,
            weightControlMethod = action.weightControlMethod,
            catchesWeighedAtLanding = action.catchesWeighedAtLanding,
            ...
            isINNControl = action.isINNControl,
            gangwayPresentAndCompliant = action.gangwayPresentAndCompliant,
            isUnitBoarded = action.isUnitBoarded,
