        ...
        fun fromMissionActionEntity(action: MissionActionEntity): MissionFishAction {
            ...
            return MissionFishAction(
                ...
                data = MissionFishActionData(
                    ...
                    vmsEmissionControlBeforeArrival = fishAction.vmsEmissionControlBeforeArrival,
                    portEntranceAndLandingAuthorized = fishAction.portEntranceAndLandingAuthorized,
                    logbookOpenedPriorToControl = fishAction.logbookOpenedPriorToControl,
                    flightGoals = fishAction.flightGoals ?: listOf(),
                    ...
                    propulsionEnginePowerControl = fishAction.propulsionEnginePowerControl,
                    fishingLicencesMatchActivity = fishAction.fishingLicencesMatchActivity,
                    europeanFishingLicenceValid = fishAction.europeanFishingLicenceValid,
                    weighingOperationsMonitoredByInspectors = fishAction.weighingOperationsMonitoredByInspectors,
                    stowagePlanPresent = fishAction.stowagePlanPresent,
                    onboardWeighingPermit = fishAction.onboardWeighingPermit,
                    weighingCertificateAndSystemsValid = fishAction.weighingCertificateAndSystemsValid,
                    underSizedSeparateStowage = fishAction.underSizedSeparateStowage,
                    underSizedSeparateRecording = fishAction.underSizedSeparateRecording,
                    minimumConservationReferenceSizeControlled = fishAction.minimumConservationReferenceSizeControlled,
                    cratesWeighingSamplingControl = fishAction.cratesWeighingSamplingControl,
                    approvedWeighingOperatorInformation = fishAction.approvedWeighingOperatorInformation,
                    holdControlledAfterUnloading = fishAction.holdControlledAfterUnloading,
                    weightControlMethod = fishAction.weightControlMethod,
                    catchesWeighedAtLanding = fishAction.catchesWeighedAtLanding,
                    ...
                    discardedSpecies = fishAction.discardedSpecies?: listOf(),
                    isFromPoseidon = fishAction.isFromPoseidon,
                    vesselGroups = fishAction.vesselGroups ?: listOf(),
                    tripReportings = fishAction.tripReportings ?: listOf(),
                    isPrioritized = fishAction.isPrioritized,
                    ...
                    isLastHaul = fishAction.isLastHaul,
                    ...
                    isINNControl = fishAction.isINNControl,
                    gangwayPresentAndCompliant = fishAction.gangwayPresentAndCompliant,
                    isUnitBoarded = fishAction.isUnitBoarded,
