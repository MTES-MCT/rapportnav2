...
class MissionNavActionEntity(
    ...
    @field:Min(value = 0, groups = [ValidateThrowsBeforeSave::class], message = "Le nombre de navires interceptés doit être positif")
    override var nbOfInterceptedVessels: Int? = null,
    @field:Min(value = 0, groups = [ValidateThrowsBeforeSave::class], message = "Le nombre de migrants interceptés doit être positif")
    override var nbOfInterceptedMigrants: Int? = null,
    @field:Min(value = 0, groups = [ValidateThrowsBeforeSave::class], message = "Le nombre de passeurs interceptés doit être positif")
    ...
    @field:Min(value = 0, groups = [ValidateThrowsBeforeSave::class], message = "Le nombre de personnes secourues doit être positif")
    override var numberPersonsRescued: Int? = null,
    @field:Min(value = 0, groups = [ValidateThrowsBeforeSave::class], message = "Le nombre de personnes décédées doit être positif")
    ...
    @field:Min(value = 0, groups = [ValidateThrowsBeforeSave::class], message = "Le nombre de navires doit être positif")
    ...
    @field:Min(value = 0, groups = [ValidateThrowsBeforeSave::class], message = "Le nombre de visites doit être positif")
