...
class Control(
    ...
    fun toControlEntity(): ControlEntity {
        return ControlEntity(
            ...
            compliantSafeManningPermit = compliantSafeManningPermit,
    ...
    companion object {
        fun fromControlEntity(entity: ControlEntity): Control {
            return Control(
                id = entity.id,
                ...
                compliantSafeManningPermit = entity.compliantSafeManningPermit,
                ...
                infractions = entity.infractions?.map { Infraction.fromInfractionEntity(it) }?.sortedBy { it.id },
            )
        }
    }
}
