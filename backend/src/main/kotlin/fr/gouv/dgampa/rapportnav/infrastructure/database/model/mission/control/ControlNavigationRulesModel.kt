...
data class ControlNavigationRulesModel(
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "control_navigation_rules_id_seq")
    @SequenceGenerator(name = "control_navigation_rules_id_seq", allocationSize = 1)
    ...
    fun toControlNavigationRules() = actionControl.id?.let {
        ControlNavigationRules(
        id = id,
        missionId = missionId,
        actionControlId = it,
        confirmed = confirmed,
