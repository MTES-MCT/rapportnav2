...
@JsonSubTypes(
    JsonSubTypes.Type(ActionControlEnvEntity::class, name = "CONTROL"),
    JsonSubTypes.Type(ActionSurveillanceEnvEntity::class, name = "SURVEILLANCE"),
    JsonSubTypes.Type(ActionNoteEnvEntity::class, name = "NOTE"),
)
abstract class ActionEnvEntity(
    open val id: UUID,
