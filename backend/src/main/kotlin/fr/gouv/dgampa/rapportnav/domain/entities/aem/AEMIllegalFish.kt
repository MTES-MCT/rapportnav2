...
data class AEMIllegalFish(
    ...
    companion object {
        fun getNbrOfHourAtSea(fishActions: List<FishActionEntity?>,
            ...
            // equals to 3.4.1 + 7.4
            val navAndAnchored = AEMSovereignProtect(navActions = navActions, envActions = emptyList(), fishActions = fishActions, missionEndDateTime = missionEndDateTime).nbrOfHourAtSea
